#!/bin/bash
# Script para criar e executar verificar-dispositivos.js no servidor

cat > /tmp/verificar-dispositivos.js << 'EOFSCRIPT'
#!/usr/bin/env node
// Script para verificar dispositivos no banco de dados
...
async function main() {
  ...
  try {
    ...
    // Buscar especificamente por 'LOPESUL-HOTSPOT-06'
...
echo "✅ Script criado em /tmp/verificar-dispositivos.js"
echo "📋 Execute no servidor:"
echo "   cd /opt/lopesul-dashboard && node /tmp/verificar-dispositivos.js"
