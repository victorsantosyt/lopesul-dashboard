...
# Execute: ssh root@67.211.212.18 e depois cole o conteúdo abaixo

cat << 'SCRIPT' | ssh -i ~/.ssh/id_ed25519 root@67.211.212.18 'bash -s'
cd /opt/lopesul-dashboard

cat > /tmp/verificar-dispositivos.js << 'EOF'
